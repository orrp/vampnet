        ...
        with gr.Column():
            with gr.Accordion("manual controls", open=True):
                ...
                preset_dropdown = gr.Dropdown(
                    label="preset",
                    choices=["timbre transfer", "small variation", "small variation (follow beat)", "medium variation",
                             "medium variation (follow beat)", "large variation", "large variation (follow beat)",
                             "unconditional"],
